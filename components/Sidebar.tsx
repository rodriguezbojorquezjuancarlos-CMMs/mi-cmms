...
// 🌍 MENÚ TRADUCIDO AL INGLÉS Y CON SISTEMA DE PERMISOS (Agregado 'directivo' a todos)
  const navLinks = [
   ...
   { nombre: 'Upcoming Projects', ruta: '/projects/upcoming', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />, roles: ['admin', 'supervisor', 'directivo'] },
    ...
    { nombre: 'Operator Kiosk', ruta: '/kiosko', icon: <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />, roles: ['admin', 'supervisor', 'tecnico', 'directivo', 'operador'] },
